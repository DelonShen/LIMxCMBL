...
for lambda_idx in "${lambda_idxs[@]}"; do
    ...
    job_name="009.010-${zmin}-${zmax}-${lambda_formatted}-nbins-${nbins}-no-window"
...
python -u 009.010.2025-09-11-comb-cov-bin-mpm-quad-no-window.py ${lambda_idx} ${nbins} ${zmin} ${zmax}
