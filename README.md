...
- **Unfiltered LIM x CMB lensing cross spectrum** [`009.015`](009.015.2025-09-16-unifed-Ik.py)
...
- **High-pass filtered LIM noise spectrum** [`008.022`](008.022.2025-09-12-noise-with-finite-vol.py)
    - Mathematica notebook computing the analytical form of the filtered LIM noise spectra summands in terms of sine- and cosine-integrals can be found at [`008.023`](008.023.2025-09-12-analytical-eLOeLO-DFT-summand.wls).
