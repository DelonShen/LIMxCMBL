...
while IFS= read -r line; do
    ...
    job_name="010.000-${zmin}-${zmax}-${line}"
...
python -u 010.000.2025-09-16.unfiltered_auto_unifed.py ${zmin} ${zmax} ${line} nLC
python -u 010.000.2025-09-16.unfiltered_auto_unifed.py ${zmin} ${zmax} ${line}
