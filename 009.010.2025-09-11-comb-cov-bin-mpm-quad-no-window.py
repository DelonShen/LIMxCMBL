...
oup_fname = '/scratch/users/delon/LIMxCMBL/eHIeHI/mpmath_comb_zmin_%.5f_zmax_%.5f_Lambda_idx_%.d_from_quad_nbins_%d_no_window.npy'%(zmin, zmax, Lambda_idx, nbins)
print(oup_fname)
...
def compute_bin_element(params):
    ...
    integrand = lambda x, xp: (f_eLOeLO_no_window(chi=x,
                                                  chip=xp,
                                                  Lambda=Lambda)
