...
for lambda_idx in $(seq ${lm} 24); do
      ...
      job_name="009.018-${name}-${lambda_idx}-nb-${nb}-dblquad"
...
python -u 009.018.2025-09-10.dblquad_IHiKappa_comb_noLC.py ${lambda_idx} ${nb} \$SLURM_ARRAY_TASK_ID ${zmin} ${zmax} ${line}
